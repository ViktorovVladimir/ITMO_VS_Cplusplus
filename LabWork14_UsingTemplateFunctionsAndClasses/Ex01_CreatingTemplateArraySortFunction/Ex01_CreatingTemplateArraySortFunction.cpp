/*
    Ex01.Creating a Template Array Sort Function.

    In this exercise, you will create a template function to sort an array of elements of different types.
*/
